...
_Generated: 2026-08-24T05:09:45.383838+00:00_  
...
| `lat` | 33 | 82.5% |
| `lng` | 33 | 82.5% |
| `is_in_development` | 17 | 42.5% |
| `is_beachfront` | 12 | 30.0% |
| `zone` | 8 | 20.0% |
| `department` | 8 | 20.0% |
| `is_repriced` | 1 | 2.5% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 7 | 17.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 1 | 2.5% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 3 | 7.5% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 11 | 27.5% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 13 | 32.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 4 | 10.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 12 | 30.0% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 5.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 12 | 30.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 7.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 12 | 30.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 5.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 7 | 17.5% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 8 | 20.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 1 | 2.5% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 5.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 12 | 30.0% |
