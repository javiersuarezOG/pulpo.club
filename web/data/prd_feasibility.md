...
_Generated: 2026-09-09T08:56:44.804530+00:00_  
...
| `is_tourist` | 5 | 15.2% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 10 | 30.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 6.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 10 | 30.3% |
