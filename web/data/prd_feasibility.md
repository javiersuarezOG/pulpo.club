...
_Generated: 2026-08-08T18:03:26.900921+00:00_  
...
| `lat` | 22 | 84.6% |
| `lng` | 22 | 84.6% |
| `is_in_development` | 10 | 38.5% |
| `zone` | 6 | 23.1% |
| `department` | 6 | 23.1% |
| `is_beachfront` | 6 | 23.1% |
| `is_repriced` | 1 | 3.8% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 5 | 19.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 4 | 15.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 6 | 23.1% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 13 | 50.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 2 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 6 | 23.1% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 3.8% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 7 | 26.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 11.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 6 | 23.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 3.8% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 4 | 15.4% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 5 | 19.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_recreational` | 1 | 3.8% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 8 | 30.8% |
