...
_Generated: 2026-09-08T08:39:32.664834+00:00_  
...
| `has_water_body` | 14 | 35.9% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `is_flat` | 8 | 20.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 2 | 5.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 10 | 25.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 7 | 17.9% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 13 | 33.3% | ≥ 15% (gate) | 🟢 surface-eligible |
