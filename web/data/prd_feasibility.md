...
_Generated: 2026-06-29T08:28:35.852319+00:00_  
...
| `lat` | 21 | 75.0% |
| `lng` | 21 | 75.0% |
| `is_beachfront` | 9 | 32.1% |
| `is_in_development` | 7 | 25.0% |
| `zone` | 4 | 14.3% |
| `department` | 4 | 14.3% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 6 | 21.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 6 | 21.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_power` | 5 | 17.9% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 8 | 28.6% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 12 | 42.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 10.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 9 | 32.1% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 7.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 4 | 14.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_motivated` | 3 | 10.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 9 | 32.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 7.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 6 | 21.4% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `land_commercial` | 3 | 10.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| ALL 3 of 3 utility signals (PRD spec) | 2 | 7.1% |
