...
_Generated: 2026-09-04T08:45:22.413330+00:00_  
...
| `lat` | 33 | 84.6% |
| `lng` | 33 | 84.6% |
| `is_in_development` | 17 | 43.6% |
| `is_beachfront` | 13 | 33.3% |
| `zone` | 10 | 25.6% |
| `department` | 10 | 25.6% |
| `is_repriced` | 2 | 5.1% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 7 | 17.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 3 | 7.7% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 7 | 17.9% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 9 | 23.1% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 17 | 43.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_beachfront` | 13 | 33.3% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 11 | 28.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 13 | 33.3% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 11 | 28.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 5.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
