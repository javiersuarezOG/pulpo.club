...
_Generated: 2026-08-11T05:28:22.925107+00:00_  
...
| `lat` | 24 | 82.8% |
| `lng` | 24 | 82.8% |
| `is_in_development` | 11 | 37.9% |
| `zone` | 7 | 24.1% |
| `department` | 7 | 24.1% |
| `is_beachfront` | 6 | 20.7% |
| `is_repriced` | 1 | 3.4% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 5 | 17.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 3 | 10.3% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 7 | 24.1% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 14 | 48.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 6 | 20.7% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 6.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 9 | 31.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 6 | 20.7% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 3.4% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 4 | 13.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_walk_to_beach` | 3 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 5 | 17.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 3 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 9 | 31.0% |
