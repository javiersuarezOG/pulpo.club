...
_Generated: 2026-09-05T08:26:49.889811+00:00_  
...
| `lat` | 35 | 92.1% |
| `lng` | 35 | 92.1% |
| `is_beachfront` | 14 | 36.8% |
| `is_in_development` | 14 | 36.8% |
| `zone` | 11 | 28.9% |
| `department` | 11 | 28.9% |
| `is_repriced` | 1 | 2.6% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 8 | 21.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 5.3% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 5 | 13.2% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 10 | 26.3% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 12 | 31.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 7.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 14 | 36.8% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 10 | 26.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 7.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 14 | 36.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 9 | 23.7% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 10 | 26.3% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 15 | 39.5% |
