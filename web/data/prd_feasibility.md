...
_Generated: 2026-06-30T07:46:44.977899+00:00_  
...
| `has_ocean_view` | 7 | 20.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 6 | 17.6% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_power` | 6 | 17.6% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 11 | 32.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 15 | 44.1% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `is_on_lake` | 3 | 8.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 7 | 20.6% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 7 | 20.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 1 | 2.9% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 3 | 8.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 14 | 41.2% |
| ALL 3 of 3 utility signals (PRD spec) | 2 | 5.9% |
