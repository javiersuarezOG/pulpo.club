...
_Generated: 2026-07-21T06:59:38.168958+00:00_  
...
| `has_power` | 1 | 3.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_water` | 10 | 30.3% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 9 | 27.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 5 | 15.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_beachfront` | 5 | 15.2% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 4 | 12.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_motivated` | 6 | 18.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 5 | 15.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 6.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 8 | 24.2% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 7 | 21.2% | ≥ 15% (gate) | 🟢 surface-eligible |
