...
_Generated: 2026-08-02T07:12:20.135550+00:00_  
...
| `lat` | 28 | 87.5% |
| `lng` | 28 | 87.5% |
| `is_in_development` | 8 | 25.0% |
| `is_beachfront` | 7 | 21.9% |
| `zone` | 6 | 18.8% |
| `department` | 6 | 18.8% |
| `is_repriced` | 1 | 3.1% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 8 | 25.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 4 | 12.5% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 8 | 25.0% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 10 | 31.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 9.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 7 | 21.9% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 8 | 25.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 6 | 18.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 7 | 21.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 3.1% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 8 | 25.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 1 | 3.1% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| `land_recreational` | 2 | 6.2% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
