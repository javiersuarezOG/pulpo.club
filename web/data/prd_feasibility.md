...
_Generated: 2026-09-03T08:35:51.533744+00:00_  
...
| `lat` | 31 | 75.6% |
| `lng` | 31 | 75.6% |
| `is_in_development` | 17 | 41.5% |
| `is_beachfront` | 16 | 39.0% |
| `zone` | 11 | 26.8% |
| `department` | 11 | 26.8% |
| `is_repriced` | 3 | 7.3% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 7 | 17.1% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `is_beachfront` | 16 | 39.0% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 4.9% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 11 | 26.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 4 | 9.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 16 | 39.0% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 15 | 36.6% |
