...
_Generated: 2026-09-18T09:16:30.267834+00:00_  
...
| `lat` | 27 | 81.8% |
| `lng` | 27 | 81.8% |
| `is_beachfront` | 11 | 33.3% |
| `is_in_development` | 11 | 33.3% |
| `zone` | 9 | 27.3% |
| `department` | 9 | 27.3% |
| `is_repriced` | 2 | 6.1% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 6 | 18.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 6.1% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 5 | 15.2% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 5 | 15.2% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 14 | 42.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_beachfront` | 11 | 33.3% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 8 | 24.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 4 | 12.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 11 | 33.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 3 | 9.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 10 | 30.3% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 6 | 18.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_recreational` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
