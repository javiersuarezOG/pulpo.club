...
_Generated: 2026-07-05T07:42:59.515276+00:00_  
...
| `lat` | 25 | 73.5% |
| `lng` | 25 | 73.5% |
| `is_in_development` | 12 | 35.3% |
| `is_beachfront` | 9 | 26.5% |
| `zone` | 8 | 23.5% |
| `department` | 8 | 23.5% |
| `is_repriced` | 1 | 2.9% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 6 | 17.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 4 | 11.8% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 3 | 8.8% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 9 | 26.5% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 11 | 32.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 8.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 9 | 26.5% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 2.9% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 8 | 23.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 4 | 11.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 9 | 26.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 4 | 11.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 8 | 23.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 1 | 2.9% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `has_sewage` | 1 | 2.9% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 6 | 17.6% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 13 | 38.2% |
