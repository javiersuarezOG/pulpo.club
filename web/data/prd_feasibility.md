...
_Generated: 2026-08-14T05:45:44.500816+00:00_  
...
| `lat` | 33 | 84.6% |
| `lng` | 33 | 84.6% |
| `is_beachfront` | 11 | 28.2% |
| `is_in_development` | 11 | 28.2% |
| `zone` | 7 | 17.9% |
| `department` | 7 | 17.9% |
| `is_repriced` | 1 | 2.6% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 9 | 23.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 1 | 2.6% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 4 | 10.3% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 8 | 20.5% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 12 | 30.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 4 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 11 | 28.2% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 10 | 25.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 4 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 11 | 28.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 9 | 23.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 2 | 5.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 4 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 4 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_recreational` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 12 | 30.8% |
