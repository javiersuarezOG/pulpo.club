...
_Generated: 2026-07-18T06:31:06.671867+00:00_  
...
| `has_ocean_view` | 3 | 9.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| `is_flat` | 4 | 12.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
