...
_Generated: 2026-09-10T08:53:10.997306+00:00_  
...
| `has_ocean_view` | 5 | 15.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 1 | 3.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 4 | 12.1% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 6 | 18.2% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 15 | 45.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 9.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 7 | 21.2% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 7 | 21.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 2 | 6.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 7 | 21.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 3 | 9.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 6 | 18.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 1 | 3.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
