...
_Generated: 2026-08-26T05:00:53.195025+00:00_  
...
| `has_water_body` | 15 | 42.9% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `is_tourist` | 3 | 8.6% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| `land_commercial` | 2 | 5.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 11 | 31.4% |
