...
_Generated: 2026-08-10T05:29:49.918517+00:00_  
_Catalog size: **30 listings**_  
...
| `url` | 30 | 100.0% |
| `title` | 30 | 100.0% |
| `description>20` | 30 | 100.0% |
| `price_usd` | 30 | 100.0% |
| `first_seen_at` | 30 | 100.0% |
| `scraped_at` | 30 | 100.0% |
| `photo_urls>0` | 30 | 100.0% |
| `photos_count>0` | 30 | 100.0% |
| `broker_name` | 30 | 100.0% |
| `property_type!=land` | 30 | 100.0% |
| `days_listed` | 30 | 100.0% |
| `lat` | 24 | 80.0% |
| `lng` | 24 | 80.0% |
| `is_in_development` | 13 | 43.3% |
| `zone` | 7 | 23.3% |
| `department` | 7 | 23.3% |
| `is_beachfront` | 6 | 20.0% |
| `is_repriced` | 1 | 3.3% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 5 | 16.7% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 4 | 13.3% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 7 | 23.3% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 15 | 50.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 10.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 6 | 20.0% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 6.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 10 | 33.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 10.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 6 | 20.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 3.3% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 4 | 13.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_walk_to_beach` | 2 | 6.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 6 | 20.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 3 | 10.0% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_recreational` | 1 | 3.3% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 9 | 30.0% |
