...
_Generated: 2026-07-09T07:55:55.356116+00:00_  
...
|---|---:|---:|---:|---|
| `has_mountain_view` | 1 | 2.7% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `has_ocean_view` | 4 | 10.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_paved_access` | 2 | 5.4% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_water` | 10 | 27.0% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 12 | 32.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 5 | 13.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 8 | 21.6% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 7 | 18.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 6 | 16.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 8 | 21.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| `zoning_residential` | 5 | 13.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `zoning_tourist` | 1 | 2.7% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 11 | 29.7% |
