...
_Generated: 2026-08-12T05:50:50.676025+00:00_  
...
| `has_ocean_view` | 6 | 20.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 0 | 0.0% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 3 | 10.0% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 6 | 20.0% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 12 | 40.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 4 | 13.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 6 | 20.0% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 6.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 9 | 30.0% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `is_tourist` | 5 | 16.7% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 5 | 16.7% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 8 | 26.7% |
