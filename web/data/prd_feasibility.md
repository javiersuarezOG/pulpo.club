...
_Generated: 2026-09-20T09:38:11.561409+00:00_  
...
| `lng` | 38 | 86.4% |
| `broker_name` | 33 | 75.0% |
| `is_beachfront` | 12 | 27.3% |
| `is_in_development` | 8 | 18.2% |
| `zone` | 7 | 15.9% |
| `department` | 7 | 15.9% |
| `is_repriced` | 1 | 2.3% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 19 | 43.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 4.5% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 5 | 11.4% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 7 | 15.9% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 16 | 36.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 2 | 4.5% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_beachfront` | 12 | 27.3% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 2.3% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 10 | 22.7% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 6.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 12 | 27.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 4.5% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 5 | 11.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_walk_to_beach` | 2 | 4.5% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 4 | 9.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 12 | 27.3% |
