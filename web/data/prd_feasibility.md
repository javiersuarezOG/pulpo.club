...
_Generated: 2026-07-25T07:03:14.312768+00:00_  
...
| `lat` | 23 | 71.9% |
| `lng` | 23 | 71.9% |
| `is_in_development` | 10 | 31.2% |
| `zone` | 8 | 25.0% |
| `department` | 8 | 25.0% |
| `is_beachfront` | 6 | 18.8% |
| `is_repriced` | 2 | 6.2% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 2 | 6.2% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_paved_access` | 2 | 6.2% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 3 | 9.4% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 11 | 34.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 14 | 43.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 6 | 18.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_beachfront` | 6 | 18.8% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 3.1% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 8 | 25.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 7 | 21.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 6 | 18.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 6.2% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 9 | 28.1% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 5 | 15.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 1 | 3.1% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 2 | 6.2% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 13 | 40.6% |
