...
_Generated: 2026-07-20T07:25:05.862674+00:00_  
...
| `lat` | 22 | 68.8% |
| `lng` | 22 | 68.8% |
| `is_in_development` | 11 | 34.4% |
| `zone` | 7 | 21.9% |
| `department` | 7 | 21.9% |
| `is_beachfront` | 5 | 15.6% |
| `is_repriced` | 3 | 9.4% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 3 | 9.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| `has_water_body` | 12 | 37.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 4 | 12.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 5 | 15.6% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 6 | 18.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 7 | 21.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 5 | 15.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 4 | 12.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 11 | 34.4% |
