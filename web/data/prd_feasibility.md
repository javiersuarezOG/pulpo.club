...
_Generated: 2026-08-13T05:48:27.015921+00:00_  
...
| `has_water` | 5 | 17.9% | ≥ 40% | 🟡 above 15% gate, below PRD target |
...
| `is_flat` | 8 | 28.6% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 4 | 14.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 8 | 28.6% |
