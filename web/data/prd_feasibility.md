...
_Generated: 2026-09-11T09:17:45.831590+00:00_  
...
| `lat` | 33 | 89.2% |
| `lng` | 33 | 89.2% |
| `is_in_development` | 11 | 29.7% |
| `zone` | 9 | 24.3% |
| `department` | 9 | 24.3% |
| `is_beachfront` | 7 | 18.9% |
| `is_repriced` | 2 | 5.4% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
| `zone_specific` | 0 | 0.0% |
...
| `has_ocean_view` | 7 | 18.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 1 | 2.7% | ≥ 40% | 🔴 below 5% — needs scraper depth |
| `has_power` | 3 | 8.1% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 9 | 24.3% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 15 | 40.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 4 | 10.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 7 | 18.9% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 1 | 2.7% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_flat` | 6 | 16.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 7 | 18.9% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 3 | 8.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 9 | 24.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 9 | 24.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_commercial` | 1 | 2.7% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 13 | 35.1% |
