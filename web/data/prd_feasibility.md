...
_Generated: 2026-08-23T04:59:23.788666+00:00_  
...
| `is_flat` | 9 | 24.3% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 8.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 10 | 27.0% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 5.4% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 6 | 16.2% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 8 | 21.6% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 10 | 27.0% |
