...
_Generated: 2026-07-15T06:31:35.114485+00:00_  
...
| `has_water` | 11 | 37.9% | ≥ 40% | 🟡 above 15% gate, below PRD target |
...
| `is_on_lake` | 3 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 7 | 24.1% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 13 | 44.8% |
