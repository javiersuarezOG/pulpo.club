...
_Generated: 2026-07-19T07:02:25.719869+00:00_  
...
| `has_ocean_view` | 4 | 12.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_paved_access` | 2 | 6.5% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 3 | 9.7% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 10 | 32.3% | ≥ 40% | 🟡 above 15% gate, below PRD target |
...
| `is_commercial` | 1 | 3.2% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| `is_tourist` | 9 | 29.0% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 7 | 22.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 2 | 6.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_commercial` | 1 | 3.2% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 11 | 35.5% |
