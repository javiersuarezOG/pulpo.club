...
_Generated: 2026-09-01T09:30:50.981559+00:00_  
...
| `lat` | 32 | 82.1% |
| `lng` | 32 | 82.1% |
| `is_in_development` | 15 | 38.5% |
| `is_beachfront` | 12 | 30.8% |
| `zone` | 8 | 20.5% |
| `department` | 8 | 20.5% |
| `is_repriced` | 4 | 10.3% |
| `area_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 5 | 12.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_paved_access` | 3 | 7.7% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 6 | 15.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water` | 10 | 25.6% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 15 | 38.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 12 | 30.8% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 2 | 5.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 11 | 28.2% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 12 | 30.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_tourist` | 8 | 20.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 4 | 10.3% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 8 | 20.5% | ≥ 15% (gate) | 🟢 surface-eligible |
