...
_Generated: 2026-08-17T04:34:23.889600+00:00_  
...
| `lat` | 30 | 88.2% |
| `lng` | 30 | 88.2% |
| `is_in_development` | 11 | 32.4% |
| `is_beachfront` | 8 | 23.5% |
| `zone` | 7 | 20.6% |
| `department` | 7 | 20.6% |
| `area_m2` | 0 | 0.0% |
| `price_per_m2` | 0 | 0.0% |
...
| `has_ocean_view` | 8 | 23.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 5.9% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 3 | 8.8% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 7 | 20.6% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 10 | 29.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 8.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 8 | 23.5% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 3 | 8.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 7 | 20.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 4 | 11.8% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_on_beach` | 8 | 23.5% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `land_commercial` | 5 | 14.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 10 | 29.4% |
