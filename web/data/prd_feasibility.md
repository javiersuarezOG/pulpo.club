...
_Generated: 2026-09-14T09:58:44.910242+00:00_  
...
| `has_ocean_view` | 6 | 15.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 5.1% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 4 | 10.3% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 6 | 15.4% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 17 | 43.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 2 | 5.1% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 10 | 25.6% | ≥ 15% | 🟢 meets PRD target |
...
| `is_on_beach` | 10 | 25.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 3 | 7.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 10 | 25.6% | ≥ 15% (gate) | 🟢 surface-eligible |
...
| `zoning_residential` | 10 | 25.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 0 | 0.0% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `land_commercial` | 1 | 2.6% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
...
| Definition | Hits | % |
|---|---:|---:|
| ANY 1 of 3 utility signals (relaxed) | 11 | 28.2% |
