...
_Generated: 2026-06-21T08:33:03.572348+00:00_  
...
| `lat` | 12 | 38.7% |
| `lng` | 12 | 38.7% |
| `is_in_development` | 12 | 38.7% |
| `is_beachfront` | 8 | 25.8% |
| `zone` | 4 | 12.9% |
| `department` | 4 | 12.9% |
| `is_repriced` | 1 | 3.2% |
| `area_m2` | 0 | 0.0% |
...
|---|---:|---:|---:|---|
| `has_mountain_view` | 1 | 3.2% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `has_ocean_view` | 8 | 25.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `has_paved_access` | 2 | 6.5% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_power` | 3 | 9.7% | ≥ 40% | 🟡 computed only, below UI gate |
| `has_water` | 9 | 29.0% | ≥ 40% | 🟡 above 15% gate, below PRD target |
| `has_water_body` | 11 | 35.5% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_agricultural` | 3 | 9.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_beachfront` | 8 | 25.8% | ≥ 15% | 🟢 meets PRD target |
| `is_commercial` | 3 | 9.7% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_flat` | 6 | 19.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_motivated` | 5 | 16.1% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_beach` | 8 | 25.8% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_on_lake` | 2 | 6.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `is_tourist` | 7 | 22.6% | ≥ 15% (gate) | 🟢 surface-eligible |
| `is_walk_to_beach` | 2 | 6.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `has_sewage` | 1 | 3.2% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `is_repriced_text` | 1 | 3.2% | ≥ 15% (gate) | 🔴 below 5% — needs scraper depth |
| `zoning_residential` | 6 | 19.4% | ≥ 15% (gate) | 🟢 surface-eligible |
| `zoning_tourist` | 2 | 6.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_commercial` | 4 | 12.9% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
| `land_recreational` | 2 | 6.5% | ≥ 15% (gate) | 🟡 computed only, below UI gate |
