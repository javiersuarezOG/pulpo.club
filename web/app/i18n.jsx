...
const UI_STRINGS = {
  ...
  "admin.ig_review.submit_disabled_hint": {
    en: "Submission ships in PR-4 alongside the publisher — decisions persist in local storage until then.",
    es: "El envío llega en PR-4 junto al publisher — las decisiones quedan en local storage hasta entonces.",
  },
