...
const UI_STRINGS = {
  ...
  "home.hero.v4.rank_aria":      { en: "Pulpo ranked #{rank} today",
                                   es: "Pulpo: #{rank} hoy" },
  "home.hero.v4.why_template":   { en: "Why #{rank}: {parts}",
                                   es: "Por qué #{rank}: {parts}" },
  "home.hero.v4.score.value":    { en: "Value {n}",
                                   es: "Valor {n}" },
  "home.hero.v4.score.location": { en: "Location {n}",
                                   es: "Ubicación {n}" },
  "home.hero.v4.score.momentum": { en: "Momentum {n}",
                                   es: "Impulso {n}" },
  "home.hero.v4.photo_aria":     { en: "Open today's #{rank} pick in {name}",
                                   es: "Abrir la #{rank} de hoy en {name}" },
