...
const UI_STRINGS = {
  ...
  "home.hero.v4.kicker":         { en: "PULPO · BEACH + LAKE",
                                   es: "PULPO · PLAYA + LAGO" },
  "home.hero.v4.subhead":        { en: "Curated weekly by locals. Browse the full catalog or get the top picks in your inbox.",
                                   es: "Cada semana, curadas por locales. Explora el catálogo completo o recibe lo mejor en tu correo." },
