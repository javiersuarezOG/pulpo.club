...
const SHELVES = [
  { key: "new_this_week",    label: { en: "Fresh Off the Radar",          es: "Recién aparecidos" },           subline: { en: "This week's best additions, first.",                    es: "Lo mejor que entró esta semana, primero." },              icon: "cat_new",          filter: (l) => typeof l.first_seen_date === "number" && l.first_seen_date <= 7 },
...
//
// Phase 4 (May 2026) deleted the PillRail. PILL_GROUPS + PILLS were
// the rail's source-of-truth and the label-lookup table; both are
// gone. The chips they defined now live in the FilterPanel's Primary
