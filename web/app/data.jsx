...
const SHELVES = [
  ...
  { key: "commercial",       label: { en: "Think Bigger",                 es: "Piensa en grande" },            subline: { en: "Land zoned for what you have in mind.",                 es: "Terreno zonificado para lo que tienes en mente." },       icon: "cat_commercial",   filter: (l) => l.land_type === "commercial" },
  ...
  { key: "under_50k",        label: { en: "Under $50K — Seriously",       es: "Menos de $50K — en serio" },    subline: { en: "Entry-point land that doesn't feel like a compromise.", es: "Terreno de entrada que no se siente como sacrificio." },  icon: "cat_under_100k",   filter: (l) => l.price <= 50000 },
