...
SCRAPER_METADATA: dict[str, dict] = {
    ...
    "santizo": {
        ...
        "fetch_kind": "static_http",
        "discovery_kind": "html_pagination",
        "extraction_kind": "jsonld_residence + WordPress /page/N/ (DRAFT)",
        "strengths": ["#1 SV agency per their own marketing", "high data completeness"],
        "failure_modes": ["DRAFT skeleton — calibration pass required", "expect overlap with encuentra24"],
        "owner_module": "pulpo.scrapers.santizo",
        "target_prd": 150,
        "target_discovered": None,
        "health_probe_url": "https://santizorealestate.com",
    },
    "citymax_sc": {
        "layer": "extraction",
        "fetch_kind": "static_http",
        "discovery_kind": "html_pagination",
        "extraction_kind": "html_cards (DRAFT) — mirror citymax.py once distinct inventory confirmed",
        "strengths": ["coastal/Surf City focus", "franchise template likely shared with citymax"],
        "failure_modes": ["DRAFT skeleton — calibration pass required", "may share inventory with citymax (verify via dedup_audit)"],
        "owner_module": "pulpo.scrapers.citymax_sc",
        "target_prd": 300,
        "target_discovered": None,
        "health_probe_url": "https://www.citymax-sc.com",
    },
    "vivolatam": {
        "layer": "extraction",
        "fetch_kind": "static_http",
    ...
    "csbr": {
        ...
        "fetch_kind": "static_http",
        "discovery_kind": "html_pagination",
        "extraction_kind": "jsonld_residence (DRAFT) — institutional inventory",
        "strengths": ["official industry guild", "high-quality member-only listings"],
        "failure_modes": ["DRAFT skeleton — calibration pass required", "low-volume but high-trust source"],
        "owner_module": "pulpo.scrapers.csbr",
        "target_prd": 100,
        "target_discovered": None,
        "health_probe_url": "https://www.camarabienesraices.com.sv",
    },
    "realtor_intl_sv": {
        "layer": "extraction",
        "fetch_kind": "curl_cffi",
